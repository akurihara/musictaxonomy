...
def main():
    ...
    session.add(graph_models.MainGenre(id=3, spotify_name='hip hop', display_name='Hip Hop'))
    ...
    session.add(graph_models.MainGenre(id=6, spotify_name='country', display_name='Country'))
    session.add(graph_models.MainGenre(id=7, spotify_name='edm', display_name='Electronic'))
    session.add(graph_models.MainGenre(id=8, spotify_name='classical', display_name='Classical'))
    session.add(graph_models.MainGenre(id=9, spotify_name='blues', display_name='Blues'))
    session.add(graph_models.MainGenre(id=10, spotify_name='reggae', display_name='Reggae'))
